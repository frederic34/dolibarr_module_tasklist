 ...
 */
class tasklistbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "tasklist@tasklist";
    public $boxlabel;
    public $depends = array("tasklist");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/tasklist/class/tasklist.class.php";
